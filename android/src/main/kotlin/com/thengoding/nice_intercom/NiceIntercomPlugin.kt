package com.thengoding.nice_intercom
...
/** NiceIntercomPlugin */
class NiceIntercomPlugin: FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler, ActivityAware {
  companion object {
    @JvmStatic
    ...
    fun registerWith(registrar: Registrar) {
      ...
      channel.setMethodCallHandler(NiceIntercomPlugin())
      val unreadEventChannel = EventChannel(registrar.messenger(), "maido.io/intercom/unread")
      unreadEventChannel.setStreamHandler(NiceIntercomPlugin())
    }
